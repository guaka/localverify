...
Canonical synthetic vectors live in `Fixtures/record-engine-*.json`; binding results, source hashes and reproduction commands are linked from `docs/SHARED-RECORD-ENGINE.md`. Production-app activation remains a later change.
